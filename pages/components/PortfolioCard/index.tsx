...
const PortfolioCard: React.FC<ProfileCardProps> = ({
	imagePath,
	title,
	description,
	activeLink,
			...
			<div className="mx-[32px] mt-[45px] text-white">
				...
				<div className="flex flex-row space-x-[15px] mt-[25px]">
					...
					{gitLink && (
						<a href={gitLink}>
							<img
								src="../icons/stack-icons/Github.svg"
