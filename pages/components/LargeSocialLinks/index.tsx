		...
		<div className="hidden lg:block mt-[120px] mx-[60px]">
			...
			<div className="flex flex-row justify-between mt-[70px]">
				<div className="flex flex-col">
					<p className="w-[300px] xl:w-[495px] text-white lg:text-[22px] font-[400]">
						Hi 👋🏿, Adetunji here. Lets get in touch sometime to work
						on something great 😅
					</p>
					<div className="mt-[60px]">
						{/* <ul className="content">
							<li className="content__item">
								<button className="button button--anthe flex">
									<p>Initialize</p>
									<img
										src="/icons/arrow.svg"
										alt=""
						...
						<Link href={"/contact"}>
							<div
								className={`text-center flex space-x-[8px] items-center justify-center grey w-[180px] h-[60.07px] custom-shadow duration-500 ease-in delay-[10ms] animate-arrow-div rounded-[4px] cursor-pointer`}
							>
				...
				<div className="lg:flex flex-col">
					<p className="w-[350px] xl:w-[495px] text-white lg:text-[22px] font-[400]">
						My handle is itzadetunji on all social media 😊. Lets
						give each other a follow 🤗
					</p>
					<div className="mt-[60px]">
