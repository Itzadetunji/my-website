    ...
    <nav className="bg-white border-gray-200 py-2.5 rounded dark-blue fixed top-0 w-full">
      <div className="container flex flex-wrap justify-between items-center mx-[30px] mt-[30px]">
        <div className="flex items-center space-x-[244px]">
            ...
            <button data-collapse-toggle="mobile-menu" className="hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200
dark:hover:bg-gray-700 dark:focus:ring-gray-600 rounded-lg" aria-controls="mobile-menu" aria-expanded="false">
        ...
        <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <li>
              <a href="#" className="block py-2 pr-4 pl-3 text-white light-blue rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</a>
            </li>
            <li>
