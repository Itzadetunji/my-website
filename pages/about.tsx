					...
					<div className="mx-[35px] lg:mx-[30px]">
							...
							<div className="mt-[100px] lg:mt-[0px] text-center lg:text-left">
								...
								<div className="lg:w-[360px] xl:w-[450px] text-center lg:text-left mx-auto font-light text-[25px] lg:text-[16px] xl:text-[20px] xl:leading-[30px] 2xl:leading-[33px]">
									<p className="mt-[20px] lg:mt-[40px]">
										...
										adipisicing elit. Eius porro deserunt
										quod, totam fugit architecto vero quae,
										explicabo deleniti minima, ratione iste
										repellendus officia. Nisi,
									</p>
									<p className="mt-[15px]">
										Lorem, ipsum dolor sit amet consectetur
										adipisicing elit. Quasi ducimus nam
										aliquam rem repudiandae, ullam iste
										deserunt praesentium repellat eos?
									</p>
									<p className="mt-[15px]">
										Lorem ipsum, dolor sit amet consectetur
										adipisicing elit. Ducimus iste ipsa
										eaque ipsum quasi consectetur
										blanditiis! Amet?{" "}
									</p>
                      ...
                      <img src="/icons/arrow.svg" alt="" className='arrow animate-arrow'/>
										...
										<a href="https://www.linkedin.com/in/adetunji-adeyinka-8aa5311b9/">
											<div
												className={`rounded-full text-center items-center justify-center grey w-[180px] h-[60.07px] custom-shadow duration-500 ease-in delay-[10ms] flex space-x-[8px] animate-arrow-div mt-[70px]`}
											>
					...
					<div className="mx-[30px]">
						...
						<div className="grid grid-rows-1 xl:grid-cols-2 xl:mr-[200px]">
							<p className="text-white font-[400] text-center xl:text-left leading-[34px] xl:leading-[40px] mt-[37px] xl:mt-[200px] text-[20px] xl:w-[350px]">
								Building a great app involves more than just
								design and programming. I listen to your
								requirements to ensure you're satisfied. Listen
								to others' comments.
							</p>
